        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <ul class="modos tabs" role="tablist">
                    <li class="active">
                        <a href="#modo-visualizacion">Modo visualización</a>
                    </li>
                    <li>
                        <a href="#modo-listado">Modo listado de nodos</a>
                    </li>
                </ul>
                ...
                <a href="{{route('node.create', $story->_id)}}">
                ...
                <div class="botones-nav-form">
                    <a href="{{ route('my-stories') }}" class="bot ant">Volver a mis relatos</a>
