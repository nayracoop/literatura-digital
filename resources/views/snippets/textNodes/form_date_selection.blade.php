...
<div class="form-padding-interno container-select-fecha">
    ...
    <div class="styled-select select-fecha">
        <select name="dia" class="dias">
            ...
            <option value="29" class="d29">29</option>
            <option value="30" class="d30">30</option>
            <option value="31" class="d31">31</option>
        </select>
    </div>
