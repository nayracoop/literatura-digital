<div class="modal fade" id="ingresar" tabindex="-1" role="dialog" aria-labelledby="modalLabel2" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-login">
      <div class="loginmodal-container">
        ...
        <div class="login-help">
          <p>@lang('¿Todavía no sos miembro?')<a href="#">@lang('Registrate')</a></p>
        </div>
      </div>
    </div>
  </div>
